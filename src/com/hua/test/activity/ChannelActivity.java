...
import com.hua.test.adapter.DragAdapter;
import com.hua.test.adapter.OtherAdapter;
...
import com.hua.test.view.DragGrid;
import com.hua.test.view.OtherGridView;
...
public class ChannelActivity extends SwipeBackActivity implements OnItemClickListener {
    ...
    private int CHANNEL_RESULT_CODE = 200;
    ...
    public void finish() {
    	if (userAdapter.isListChanged()) {
    		MainActivityPhone.isChange = true;
    		saveChannel();
    		LogUtils2.d("CHANNEL change****************** = "+CHANNEL_RESULT_CODE);
    		setResult(CHANNEL_RESULT_CODE);
    		Log.d(TAG, "数据发生改变");
    	}
        super.finish();
    }
