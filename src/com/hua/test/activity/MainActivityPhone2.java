...
public class MainActivityPhone2 extends BaseSlidingFragmentActivity{
...
//			buttom_indicate_line.setVisibility(View.VISIBLE);
//			isClickSelect = false;
//			mColumnHorizontalScrollView.smoothScrollTo(temp_scroll_distance , 0);
//			mColumnHorizontalScrollView.invalidate();
     ...
     * 选择的Column里面的Tab
     */
    private int oldScrollDistance = 0;
    //用来判断返回滑动的Bar的情况
...
//        for (int i = 0; i < mRadioGroup_content.getChildCount(); i++) {
            ...
            int k = tempCheckView.getMeasuredWidth();
            int l = tempCheckView.getLeft();
            
            LogUtils2.e("tempCheckView.getX == "+tempCheckView.getX());
            LogUtils2.e("tempCheckView == "+tempCheckView.getLeft());
           ...
           if(!isCanScrollBack){
            ...
            if(tab_postion > columnSelectIndex){
            	isScroll = false;
            	scrollDistance = l + k / 2 - mScreenWidth *5 / 7;
                if(scrollTimes%5 == 0){
                	scrollTimes = 0;
                	isCanScrollBack = true;
                }
                
            }else if(tab_postion < columnSelectIndex && oldScrollDistance >= 0){
//            	scrollDistance =  l + k / 2 - mScreenWidth *5 / 7;
            	isScroll = true;
            	if(isCanScrollBack){
            		scrollTimes ++;
...
//                            buttom_indicate_line.setVisibility(View.GONE);
                            ...
                            isClickSelect = true;
                            LogUtils2.e("XXXXXXXXXXXXXXXXXXXXXXXXXXX");
                            buttom_indicate_line.setVisibility(View.GONE);
    ...
    class MyOnClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			case R.id.add_more_columns:
				...
				MainActivityPhone2.this.openActivityForResult(ChannelActivity.class, CHANNELR_EQUEST);
