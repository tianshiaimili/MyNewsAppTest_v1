...
public class VideoAdapter extends BaseAdapter {
    ...
    private static VideoAdapter mVideoAdapter;
...
//    @RootContext
    public static  VideoAdapter getVideoAdapter(Context tempContext){
    	if(mVideoAdapter == null){
    		mVideoAdapter = new VideoAdapter(tempContext);
    	}
    	return mVideoAdapter;
    }

    
    public VideoAdapter (Context tempContext){
    	if(tempContext != null){
