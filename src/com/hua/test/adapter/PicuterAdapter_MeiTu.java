...
//@EBean
public class PicuterAdapter_MeiTu extends BaseAdapter {
	public List<PicuterModle> lists = new ArrayList<PicuterModle>();
	private static  PicuterAdapter_MeiTu mPicuterAdapter;
...
//	}
    ...
    public static PicuterAdapter_MeiTu getPicuterAdapter(Context tempContext){
    	
    	if(mPicuterAdapter == null){
    		mPicuterAdapter = new PicuterAdapter_MeiTu(tempContext);
    	}
    	return mPicuterAdapter;
    	
    }
    
    public PicuterAdapter_MeiTu (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
