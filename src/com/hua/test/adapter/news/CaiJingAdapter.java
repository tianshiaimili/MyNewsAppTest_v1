...
public class CaiJingAdapter extends BaseAdapter {
    ...
    private static CaiJingAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static CaiJingAdapter getYuLeAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new CaiJingAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public CaiJingAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
