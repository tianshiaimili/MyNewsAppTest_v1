...
public class DianYingAdapter extends BaseAdapter {
    ...
    private static DianYingAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static DianYingAdapter getYuLeAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new DianYingAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public DianYingAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
