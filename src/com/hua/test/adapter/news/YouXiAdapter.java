...
public class YouXiAdapter extends BaseAdapter {
    ...
    private static YouXiAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static YouXiAdapter getAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new YouXiAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public YouXiAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
