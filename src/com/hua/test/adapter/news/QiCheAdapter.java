...
public class QiCheAdapter extends BaseAdapter {
    ...
    private static QiCheAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static QiCheAdapter getAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new QiCheAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public QiCheAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
