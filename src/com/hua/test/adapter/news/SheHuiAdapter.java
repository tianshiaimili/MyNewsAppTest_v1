...
public class SheHuiAdapter extends BaseAdapter {
    ...
    private static SheHuiAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static SheHuiAdapter getAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new SheHuiAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public SheHuiAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
