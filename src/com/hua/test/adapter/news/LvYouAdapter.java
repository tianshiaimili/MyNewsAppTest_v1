...
public class LvYouAdapter extends BaseAdapter {
    ...
    private static LvYouAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static LvYouAdapter getAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new LvYouAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public LvYouAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
