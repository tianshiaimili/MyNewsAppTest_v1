...
public class JiaJuAdapter extends BaseAdapter {
    ...
    private static JiaJuAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static JiaJuAdapter getAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new JiaJuAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public JiaJuAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
