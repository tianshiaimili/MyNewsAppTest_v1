...
public class ShouJiAdapter extends BaseAdapter {
    public static List<NewModle> lists = new ArrayList<NewModle>();
	private String currentItem;
    private Context context;
    private static ShouJiAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static ShouJiAdapter getAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new ShouJiAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public ShouJiAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
