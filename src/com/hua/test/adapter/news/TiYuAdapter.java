...
public class TiYuAdapter extends BaseAdapter {
    public static List<NewModle> lists = new ArrayList<NewModle>();
	private String currentItem;
    private Context context;
    private static TiYuAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static TiYuAdapter getYuLeAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new TiYuAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public TiYuAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
