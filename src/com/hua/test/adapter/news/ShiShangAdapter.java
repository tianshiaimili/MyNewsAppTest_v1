...
public class ShiShangAdapter extends BaseAdapter {
    public static List<NewModle> lists = new ArrayList<NewModle>();
	private String currentItem;
    private Context context;
    private static ShiShangAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static ShiShangAdapter getAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new ShiShangAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public ShiShangAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
