...
public class ShuMaAdapter extends BaseAdapter {
    public static List<NewModle> lists = new ArrayList<NewModle>();
	private String currentItem;
    private Context context;
    private static ShuMaAdapter mNewAdapter;
...
//            LogUtils2.e("*********lists.size==***== " +lists.size());
    ...
    public static ShuMaAdapter getYuLeAdapter(Context tempContext){
    	
    	if(mNewAdapter == null){
    		mNewAdapter = new ShuMaAdapter(tempContext);
    	}
    	return mNewAdapter;
    	
    }
    
    public ShuMaAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
