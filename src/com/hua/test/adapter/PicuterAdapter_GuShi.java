...
//@EBean
public class PicuterAdapter_GuShi extends BaseAdapter {
	public List<PicuterModle> lists = new ArrayList<PicuterModle>();
	private static  PicuterAdapter_GuShi mPicuterAdapter;
...
//	}
    ...
    public static PicuterAdapter_GuShi getPicuterAdapter(Context tempContext){
    	
    	if(mPicuterAdapter == null){
    		mPicuterAdapter = new PicuterAdapter_GuShi(tempContext);
    	}
    	return mPicuterAdapter;
    	
    }
    
    public PicuterAdapter_GuShi (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
