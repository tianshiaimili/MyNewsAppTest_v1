...
//@EBean
public class PicuterAdapter_QuTu extends BaseAdapter {
	public List<PicuterModle> lists = new ArrayList<PicuterModle>();
	private static  PicuterAdapter_QuTu mPicuterAdapter;
...
//	}
    ...
    public static PicuterAdapter_QuTu getPicuterAdapter(Context tempContext){
    	
    	if(mPicuterAdapter == null){
    		mPicuterAdapter = new PicuterAdapter_QuTu(tempContext);
    	}
    	return mPicuterAdapter;
    	
    }
    
    public PicuterAdapter_QuTu (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
