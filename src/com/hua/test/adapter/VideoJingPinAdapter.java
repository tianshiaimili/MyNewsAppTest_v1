...
//@EBean
public class VideoJingPinAdapter extends BaseAdapter {
    public List<VideoModle> lists = new ArrayList<VideoModle>();
    private Context mContext;
    private static VideoJingPinAdapter mVideoAdapter;
...
//    @RootContext
    public static  VideoJingPinAdapter getVideoAdapter(Context tempContext){
    	if(mVideoAdapter == null){
    		mVideoAdapter = new VideoJingPinAdapter(tempContext);
    	}
    	return mVideoAdapter;
    }

    
    public VideoJingPinAdapter (Context tempContext){
    	if(tempContext != null){
