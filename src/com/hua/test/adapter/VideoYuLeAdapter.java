...
//@EBean
public class VideoYuLeAdapter extends BaseAdapter {
    public List<VideoModle> lists = new ArrayList<VideoModle>();
    private Context mContext;
    private static VideoYuLeAdapter mVideoAdapter;
...
//    @RootContext
    public static  VideoYuLeAdapter getVideoAdapter(Context tempContext){
    	if(mVideoAdapter == null){
    		mVideoAdapter = new VideoYuLeAdapter(tempContext);
    	}
    	return mVideoAdapter;
    }

    
    public VideoYuLeAdapter (Context tempContext){
    	if(tempContext != null){
