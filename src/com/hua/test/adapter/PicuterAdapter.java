...
public class PicuterAdapter extends BaseAdapter {
	...
	private static  PicuterAdapter mPicuterAdapter;
...
//	}
    ...
    public static PicuterAdapter getPicuterAdapter(Context tempContext){
    	
    	if(mPicuterAdapter == null){
    		mPicuterAdapter = new PicuterAdapter(tempContext);
    	}
    	return mPicuterAdapter;
    	
    }
    
    public PicuterAdapter (Context tempContext){
    	if(tempContext != null){
    		context = tempContext;
    	}
