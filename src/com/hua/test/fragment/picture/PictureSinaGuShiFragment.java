...
import com.hua.test.adapter.PicuterAdapter_GuShi;
...
public class PictureSinaGuShiFragment extends BaseFragment implements
...
//    @Bean
    protected PicuterAdapter_GuShi mPictuerAdapter;
    protected List<PicuterModle> listsModles;
    private boolean isRefresh = false;

    private static final int RESPONSE_OK = 0;
    private String cacheName ="PictureSinaGuShiFragment";
	...
	public PictureSinaGuShiFragment(int tabIndex) {
		super();
		this.mTabIndex = tabIndex;
	}
    
	public PictureSinaGuShiFragment() {
		super();
	}
...
//    		dismissProgressDialog();
    		...
    		mPictuerAdapter.appendList(list,index);
    		
    		if(mPictuerAdapter.isNeedUplistsModlesData(index)){
    ...
    public void onRefresh() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                isRefresh = true;
                index = 0;
                loadData(getSinaQuTu(index + ""),cacheName);
            }
        }, 2000);
    }
...
//		showProgressDialog();
        ...
        mPictuerAdapter = PicuterAdapter_GuShi.getPicuterAdapter(mContext);
        AnimationAdapter animationAdapter = new CardsAnimationAdapter(mPictuerAdapter);
        animationAdapter.setAbsListView(mSwipeListView);
        mSwipeListView.setAdapter(animationAdapter);
        mSwipeListView.setOnItemClickListener(new MyGuShiListViewItemListener());
        
        loadData(getSinaGuShi(index + ""),cacheName);
...
//    	photoAdapter.getLists().clear();
	...
	class MyGuShiListViewItemListener implements OnItemClickListener{
