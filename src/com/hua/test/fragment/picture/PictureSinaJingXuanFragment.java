...
import com.hua.test.adapter.PicuterAdapter_JingXuan;
import com.hua.test.adapter.PicuterAdapter_QuTu;
import com.hua.test.bean.PicuterModle;
import com.hua.test.fragment.BaseFragment;
import com.hua.test.fragment.picture.PictureSinaQuTuFragment.MyQuTuListViewItemListener;
...
public class PictureSinaJingXuanFragment extends BaseFragment implements
...
//    @Bean
    protected PicuterAdapter_JingXuan mPictureAdapter;
    protected List<PicuterModle> listsModles;
    private boolean isRefresh = false;


    private static final int RESPONSE_OK = 0;
    private String cacheName ="PictureSinaJingXuanFragment";
	...
	public PictureSinaJingXuanFragment(int tabIndex) {
		super();
		this.mTabIndex = tabIndex;
	}
    
	public PictureSinaJingXuanFragment() {
		super();
	}
...
//      		dismissProgressDialog();
      		...
      		mPictureAdapter.appendList(list,index);
      		
      		if(mPictureAdapter.isNeedUplistsModlesData(index)){
      ...
      public void onRefresh() {
          new Handler().postDelayed(new Runnable() {
              ...
              public void run() {
                  ...
                  isRefresh = true;
                  index = 0;
                  loadData(getSinaJingXuan(index + ""),cacheName);
              }
          }, 2000);
      }
...
//		LogUtils2.d("the MainActivityPhone tabIndex = "+PictureSinaActivity.getCurrentFragmentIndex());
...
//  		mProgressBar.setVisibility(View.GONE);
          ...
          mPictureAdapter = PicuterAdapter_JingXuan.getPicuterAdapter(mContext);
          AnimationAdapter animationAdapter = new CardsAnimationAdapter(mPictureAdapter);
          animationAdapter.setAbsListView(mSwipeListView);
          mSwipeListView.setAdapter(animationAdapter);
          mSwipeListView.setOnItemClickListener(new MyJingXuanListViewItemListener()); 
...
//    	photoAdapter.getLists().clear();
	...
	class MyJingXuanListViewItemListener implements OnItemClickListener{
