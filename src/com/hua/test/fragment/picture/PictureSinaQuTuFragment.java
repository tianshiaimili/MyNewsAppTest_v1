...
public class PictureSinaQuTuFragment extends BaseFragment implements
...
//    @Bean
    protected PicuterAdapter_QuTu mPicuterAdapter;
	...
	public PictureSinaQuTuFragment(int tabIndex) {
		super();
		this.mTabIndex = tabIndex;
	}
    
	public PictureSinaQuTuFragment() {
		super();
	}
...
//		mProgressBar.setVisibility(View.GONE);
        ...
        mPicuterAdapter = PicuterAdapter_QuTu.getPicuterAdapter(mContext);
        ...
        mSwipeListView.setOnItemClickListener(new MyQuTuListViewItemListener());
...
//    	photoAdapter.getLists().clear();
	...
	class MyQuTuListViewItemListener implements OnItemClickListener{
