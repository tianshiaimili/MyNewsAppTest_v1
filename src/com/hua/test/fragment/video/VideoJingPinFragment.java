...
import com.hua.test.adapter.VideoJingPinAdapter;
...
//    @Bean
    protected VideoJingPinAdapter videoAdapter;
	...
	private String cacheName ="VideoJingPinFragment";

	//当前fragment 在viewpage中的第几个页面下的index
	private int mTabIndex;
    
	public VideoJingPinFragment(int tabIndex) {
		super();
		this.mTabIndex = tabIndex;
	}
    
	public VideoJingPinFragment() {
		super();
	}
...
//		}
 		...
 		videoAdapter = VideoJingPinAdapter.getVideoAdapter(mContext);
 		...
 		loadData(getVideoUrl(index + "", Url.VideoJingPinId),cacheName);
...
//		init();
	...
	public void onResume() {
		...
		LogUtils2.e("the MainActivityPhone tabIndex = "+VideoActivity.getColumnSelectIndex());
