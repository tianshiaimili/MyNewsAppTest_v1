...
package com.hua.test.fragment.video;
...
import com.hua.test.adapter.VideoGaoXiaoAdapter;
...
//    @Bean
    protected VideoGaoXiaoAdapter videoAdapter;
	...
	private String cacheName ="VideoGaoXiaoFragment";
    
    
	//当前fragment 在viewpage中的第几个页面下的index
	private int mTabIndex;
    
	public VideoGaoXiaoFragment(int tabIndex) {
		super();
		this.mTabIndex = tabIndex;
	}
    
	public VideoGaoXiaoFragment() {
		super();
	}
...
//		listsModles = new ArrayList<VideoModle>();
	...
	protected void initContentView(View tempContentView) {
		...
		videoAdapter = VideoGaoXiaoAdapter.getVideoAdapter(mContext);
		...
		loadData(getVideoUrl(index + "", Url.VideoGaoXiaoId),cacheName);
...
//		init();
	...
	public void onResume() {
		...
		LogUtils2.e("the tabIndex = "+mTabIndex);
		LogUtils2.e("the MainActivityPhone tabIndex = "+PictureSinaActivity.getCurrentFragmentIndex());
