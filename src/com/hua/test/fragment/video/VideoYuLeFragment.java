...
import com.hua.test.adapter.VideoYuLeAdapter;
...
//    @Bean
    protected VideoYuLeAdapter videoAdapter;
	...
	private String cacheName ="VideoYuLeFragment";
    
	//当前fragment 在viewpage中的第几个页面下的index
	private int mTabIndex;
    
	public VideoYuLeFragment(int tabIndex) {
		super();
		this.mTabIndex = tabIndex;
	}
    
	public VideoYuLeFragment() {
		super();
	}
...
//			}
			...
			videoAdapter = VideoYuLeAdapter.getVideoAdapter(mContext);
			...
			loadData(getVideoUrl(index + "", Url.VideoYuLeId),cacheName);
