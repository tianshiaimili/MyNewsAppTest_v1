...
import com.hua.test.activity.PicuterDetailActivity;
import com.hua.test.activity.R;
import com.hua.test.adapter.CardsAnimationAdapter;
import com.hua.test.adapter.PicuterAdapter;
...
//    public int index = 1;
    ...
    protected PicuterAdapter mPicuterAdapter;
...
//          getResult(result);
	...
	public void initContentView(View tempContentView){
        ...
        mPicuterAdapter = PicuterAdapter.getPicuterAdapter(mContext);
