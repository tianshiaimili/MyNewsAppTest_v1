...
import com.hua.test.adapter.news.YuLeAdapter;
...
public class YuLeFragment extends BaseFragment implements
...
//	protected List< SoftReference<NewModle>> listsModles = new ArrayList< SoftReference<NewModle>>();
	...
	public YuLeFragment(int tabIndex) {
		super();
...
//    						Url.TopId);
    		...
    		List<NewModle> list =JacksonJsonUtil.readJson2NewModles(result, Url.YuLeId);
    		/////
