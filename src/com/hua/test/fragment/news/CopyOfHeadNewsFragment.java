...
public class CopyOfHeadNewsFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
...
//    /***/
	...
	public CopyOfHeadNewsFragment(int tabIndex) {
		super();
		this.mTabIndex = tabIndex;
	}
	
	public CopyOfHeadNewsFragment() {
		super();
	}
